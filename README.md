...
Para asegurar que apache está ejecutando correctamente php vamos a agregar un archivo de prueba: /var/www/html/prueba.php y entraremos a http://localhost/info.php, si entra correctamente, significa que está todo correctamente configurado.
